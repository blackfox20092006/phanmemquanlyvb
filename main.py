...
#check_frame = ttk.LabelFrame(root, text="Menu", padding=(20, 10))
#check_frame.grid(row=0, column=0, padx=(20, 10), pady=(20, 10), sticky="nsew")
#check_frame.columnconfigure(index=0, weight=1)
...
# Button
#button = ttk.Button(check_frame, text="Import folder", command=folder)
...
# Togglebutton
button = ttk.Checkbutton(widgets_frame, text="Togglebutton", style="ToggleButton.TCheckbutton")
...
for item in treeview_data:
    ...
    j += 1
# Select and scroll
treeview.selection_set(len(file_list))
treeview.see(2)
'''
# Pane #2
